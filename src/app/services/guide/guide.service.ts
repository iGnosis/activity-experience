...
import { GuideAvatarDTO } from 'src/app/types/pointmotion';
...
export class GuideService {
  ...
  getAvatarPosition(
    avatar: GuideAvatarDTO | undefined,
    avatarElm: HTMLElement,
    messageCenter: HTMLElement,
    messageBottom: HTMLElement,
  ) {
    if (messageCenter && messageBottom) {
      throw new Error(
        'System error. Why do we have messageCenter && messageBottom both present???',
      );
    }
