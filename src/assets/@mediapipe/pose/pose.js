...
*/
  ...
  Na.prototype.toJSON = function () {
    if (null == this.g) var a = '';
      ...
      (a = this.g),
        (a = this.g =
          null == a || 'string' === typeof a ? a : La && a instanceof Uint8Array ? Ha(a) : null);
    return a;
  };
  ...
  function O(a) {
    a.g > a.i &&
      ((a.j = !0), K(Error('Tried to read past the end of the data ' + a.g + ' > ' + a.i)));
  }
  function P(a) {
    var b = a.h,
      c = b[a.g],
        ...
        case 2:
          ...
          if ('detection_list' === r.type) {
            if (p) {
              var A = p.getRectList();
              for (
                var I = p.getLandmarksList(), D = p.getClassificationsList(), u = [], z = 0;
                z < A.size();
                ++z
              ) {
