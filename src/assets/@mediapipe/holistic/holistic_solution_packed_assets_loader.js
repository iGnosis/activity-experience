...
(function () {
  ...
  loadPackage({
    files: [
      {
        filename: '/third_party/mediapipe/modules/pose_detection/pose_detection.tflite',
        start: 0,
        end: 2962288,
        audio: 0,
      },
      ...
      {
        filename: '/third_party/mediapipe/modules/holistic_landmark/hand_recrop.tflite',
        start: 7289008,
        end: 7412800,
        audio: 0,
      },
      ...
      {
        filename: '/third_party/mediapipe/modules/hand_landmark/hand_landmark_full.tflite',
        start: 7412811,
        end: 12891499,
        audio: 0,
      },
