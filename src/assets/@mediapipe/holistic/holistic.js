...
*/
  ...
  z('Promise', function (a) {
    ...
    b.prototype.s = function (f, k) {
      if (0 != this.h)
        throw Error(
          'Cannot settle(' + f + ', ' + k + '): Promise already settled in state' + this.h,
        );
      this.h = f;
      this.i = k;
      2 === this.h && this.D();
  ...
  Pa.prototype.toJSON = function () {
    if (null == this.g) var a = '';
      ...
      (a = this.g),
        (a = this.g =
          null == a || 'string' === typeof a ? a : Na && a instanceof Uint8Array ? Ja(a) : null);
    return a;
  };
  ...
  function M(a) {
    a.g > a.i &&
      ((a.l = !0), ya(Error('Tried to read past the end of the data ' + a.g + ' > ' + a.i)));
  }
  ...
  function O(a, b, c) {
    ...
    if (c)
      for (b = 0; b < c.length; b++)
        (a = c[b]),
          a < this.l
            ? ((a += this.j), (d = this.h[a]) ? lb(d) : (this.h[a] = sb))
            : (tb(this), (d = this.i[a]) ? lb(d) : (this.i[a] = sb));
  }
  ...
  function ub(a, b, c) {
    ...
    e === sb
      ? ((e = lb([])), Q(a, b, e, d))
      : c && Array.isArray(e) && kb(e) & 2 && ((e = e.slice()), Q(a, b, e, d));
    return e;
  }
  function vb(a) {
    var b = ub(a, 3, !1);
  ...
  function T(a) {
    if (a.g)
      for (var b in a.g) {
        var c = a.g[b];
        if (Array.isArray(c)) for (var d = 0; d < c.length; d++) c[d] && T(c[d]);
        else c && T(c);
      }
    return a.h;
  }
  ...
  function W(a, b, c) {
    ...
    if (null != b) {
      ...
      0 === d
        ...
        ? ((d = Math.round(d / Math.pow(2, -149))), (L = 0), (K = ((c << 31) | d) >>> 0))
    ...
    return H(function (p) {
      switch (p.g) {
        ...
        case 2:
          ...
          if ('object' === typeof window)
            return (
              Ec('createMediapipeSolutionsWasm', { locateFile: a.locateFile }),
              Ec('createMediapipeSolutionsPackedAssets', { locateFile: a.locateFile }),
        ...
        case 2:
          ...
          if ('detection_list' === r.type) {
            if (p) {
              var C = p.getRectList();
              for (
                var J = p.getLandmarksList(), G = p.getClassificationsList(), u = [], A = 0;
                A < C.size();
                ++A
              ) {
  ...
  function Oc(a, b, c) {
    ...
    return H(function (e) {
      return 'number' === typeof c || c instanceof Uint8Array || c instanceof a.h.Uint8BlobList
        ...
        ? ((d = a.s[b]), d || ((d = new yc(a.h, a.D)), (a.s[b] = d)), e.return(zc(d, c, a.G)))
        : e.return(void 0);
    });
  }
  function Lc(a, b) {
      ...
      listeners: [
        {
          ...
          outs: {
            ...
            leftHandLandmarks: { type: 'proto', stream: 'left_hand_landmarks', transform: xc },
            rightHandLandmarks: { type: 'proto', stream: 'right_hand_landmarks', transform: xc },
            faceLandmarks: { type: 'proto', stream: 'face_landmarks', transform: xc },
            poseLandmarks: { type: 'proto', stream: 'pose_landmarks', transform: xc },
            ea: { type: 'proto', stream: 'world_landmarks', transform: xc },
            segmentationMask: { type: 'texture', stream: 'segmentation_mask' },
            multiFaceGeometry: { type: 'proto_list', stream: 'multi_face_geometry', transform: Pc },
          },
        },
      ],
      options: {
