      ...
      case 'object':
        if (a && !Array.isArray(a)) {
          ...
          if (a instanceof Ka) {
            var b = a.L;
            b =
              null == b || 'string' === typeof b ? b : Ha && b instanceof Uint8Array ? Da(b) : null;
            return (a.L = b) || '';
          }
        }
    }
            ...
            (k = a[e++]),
              128 > k
                ...
                ? e >= d
                  ? K()
                  : ((l = a[e++]),
                    194 > k || 128 !== (l & 192) ? (e--, K()) : f.push(((k & 31) << 6) | (l & 63)))
                : 240 > k
                ? e >= d - 1
                  ? K()
                  : ((l = a[e++]),
        ...
        case 2:
          ...
          if ('object' === typeof window)
            return (
              ...
              xc('createMediapipeSolutionsPackedAssets', { locateFile: a.locateFile }),
        ...
        case 2:
          ...
          if ('detection_list' === r.type) {
            if (p) {
              var A = p.getRectList();
              for (
                var H = p.getLandmarksList(), E = p.getClassificationsList(), u = [], z = 0;
                z < A.size();
                ++z
              ) {
  ...
  function Hc(a, b, c) {
    ...
    return I(function (e) {
      return 'number' === typeof c || c instanceof Uint8Array || c instanceof a.h.Uint8BlobList
        ...
        ? ((d = a.u[b]), d || ((d = new rc(a.h, a.G)), (a.u[b] = d)), e.return(sc(d, c, a.I)))
        : e.return(void 0);
    });
  }
  function Ec(a, b) {
